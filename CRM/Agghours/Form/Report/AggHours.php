...
class CRM_Agghours_Form_Report_AggHours extends CRM_Extendedreport_Form_Report_ExtendedReport {
  ...
  public function __construct() {
    ...
    $this->_columns = array(
        ...
        // KG
        // bikecoop:      civicrm_value_events_participants_4
        // drupal7.local: civicrm_value_events_participants_17
        'civicrm_value_events_participants_4' =>
          array(
            'dao' => 'CRM_Event_DAO_Participant',
            'fields' =>
             // drupal7.local
             // array('volunteer_hours_57' =>
             // bikecoop: actual_volunteer_time_halves_13
              array('actual_volunteer_time_halves_13' =>
                array(
                  'title' => "Most Recent Volunteer Hours",
                  'default' => TRUE,
                ),
              ),
            'group_bys' =>
